...
class Database:
    ...
    def sql_select_all_user_form_command(self):
        ...
        return self.cursor.execute(
            sql_quer.SELECT_ALL_USER_FORMS_QUERY,
        ).fetchall()
    ...
    def sql_update_user_form_command(self, telegram_id, nickname, bio,
                                     age, occupation, married, photo):
        self.cursor.execute(
            sql_quer.UPDATE_USER_FORM_QUERY,
    ...
    def sql_delete_user_form_command(self, telegram_id):
        self.cursor.execute(
            sql_quer.DELETE_USER_FORM_QUERY,
            (telegram_id,)
        )
        self.connection.commit()
    ...
    def sql_select_user_command(self, telegram_id):
        ...
        return self.cursor.execute(
            sql_quer.SELECT_USER_QUERY,
            (telegram_id,)
        ).fetchall()

    def sql_update_user_link_generation_command(self, link, telegram_id):
        self.cursor.execute(
            sql_quer.UPDATE_USER_LINK_GENERATION_QUERY,
            (link, telegram_id,)
        )
        self.connection.commit()
