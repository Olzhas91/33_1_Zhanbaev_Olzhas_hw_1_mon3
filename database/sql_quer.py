...
'''
INSERT_COMPLAINT_USER_FORM_QUERY = '''INSERT OR IGNORE INTO telegram_users VALUES (?,?,?)'''

SELECT_COMPLAINT_USER_FORM_QUERY = '''
SELECT TELEGRAM ID FROM telefram_users SET USERNAME = ?, FIRST_NAME = ?
'''
